...
\newcommand\mixin{\textbf{@Obj}\xspace}
...
the runtime, and they also do not introduce any new syntax (apart from
a small annotation): all three features are achieved by reinterpreting
