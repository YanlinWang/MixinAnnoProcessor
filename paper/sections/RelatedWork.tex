...
cleaner, typesafe and more direct.\bruno{do we want do say this?}\yanlin{need to
  ask Marco.}
...
cooperate. Some authors~\bruno{who?}\yanlin{need to ask Marco} see this as good language design
...
Here (compile/load time)\yanlin{only compile time should do?} code generation comes at the rescue: if for a certain
