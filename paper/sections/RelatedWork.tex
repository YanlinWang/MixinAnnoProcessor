...
\yanlin{Newly added discussion on CZ. please double check.}
...
semantic errors. \bruno{What happens in our approach for the same
  case?}\yanlin{explained below please double-check.} In our
...
cooperate. Some authors~\cite{bettini2013pure}\yanlin{There are many trait related papers of ferruccio
  damiani, please check whether citing this one is ok.} 
see this as good language design
...
model~\cite{malayeri2009cz}.  Object interfaces are units of reuse, and at
...
class and provide getters), then we can insert in the compilation process a tool
