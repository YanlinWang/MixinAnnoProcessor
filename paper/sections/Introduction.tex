...
application is shows how embedded DSLs using fluent interfaces~\cite{fowler2005fluentinterface} 
...
We prove that several properties hold for the translation, including a type-preservation.
