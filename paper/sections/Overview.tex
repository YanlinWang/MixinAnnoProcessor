...
\bruno{Yanlin: We need space, but we cannot make the figure {\bf unreadable}; the
  ...
  picture a bit. You can also use more space in the Java code. Since
  you are on it please fix Point2D: there's no reason for the space
  between x and y.}
...
We may tempted to assume that a language extension is needed. 
