...
\lstinputlisting[linerange=71-74]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=HORSE
...
\lstinputlisting[linerange=78-86]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=BIRD
...
\lstinputlisting[linerange=94-95]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=PEGASUS
