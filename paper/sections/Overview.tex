...
\mixin annotation.  By annotating the interface \Q@Point2D@, a variation of the shown static method
\texttt{of} will be generated, mimicking the functionality of a simple-minded
constructor: by looking at the methods that need implementation it
first detects what are the fields, then generates an \Q@of@ method with
one parameter for each of them. That is, we can just write
...
\lstinputlisting[linerange=59-59]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=ANIMAL
...
\lstinputlisting[linerange=63-64]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=HORSE
...
\lstinputlisting[linerange=68-72]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=BIRD
...
\lstinputlisting[linerange=51-56]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=POINT3D
...
\lstinputlisting[linerange=76-76]{../UseMixinLombok/src/test/TestAnimal.java}% APPLY:linerange=PEGASUS
