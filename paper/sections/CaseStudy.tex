...
&
\lstinputlisting[linerange=53-63]{../UseMixinLombok/src/test/TestExpression.java}% APPLY:linerange=EXPRESSION_PRINT
\end{tabular}
...
\lstinputlisting[linerange=87-89]{../UseMixinLombok/src/test/TestExpression.java}% APPLY:linerange=INDEPENDENT_EXTENSIBILITY
