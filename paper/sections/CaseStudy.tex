...
new solution~\cite{eptrivially} using only covariant type refinement is
...
&
\lstinputlisting[linerange=50-56]{../UseMixinLombok/src/test/TestExpression.java}% APPLY:linerange=EXPRESSION_PRINT
\end{tabular}
...
\lstinputlisting[linerange=80-82]{../UseMixinLombok/src/test/TestExpression.java}% APPLY:linerange=INDEPENDENT_EXTENSIBILITY
