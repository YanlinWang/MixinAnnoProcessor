...
The last case study is a simple Maze game, which is often
used~\cite{gof,bono14,vicentedesign} 
\bruno{where?}
\yanlin{the last one ``design patterns in OCaml''is not a proper paper, not sure
whether to cite.}
