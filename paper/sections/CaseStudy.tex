...
new solution~\cite{eptrivially}, using only covariant type refinement, has been
shown.  When such solution is modelled with interfaces and default methods, it
can even provide independent extensibility: the ability to assemble a system
