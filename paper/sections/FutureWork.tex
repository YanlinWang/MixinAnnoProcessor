...
interface is annoted with \Q!@Exposed!, we can apply a translation where a new
(package private) interface type is introduced, and the orginal interface become
