...
\yanlin{\emph{not implemented} -> abstract}
...
The function $\ofMethod$ generates the method
\QM{of}, as an object factory. To avoid boring digressions into 
well-known ways to find unique names, %for the sake of this formalization 
we assume that no-args methods start with an underscore, and we prefix method names with underscore to obtain valid  parameter names.
