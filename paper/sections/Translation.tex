...
\haoyuan{In theorem: $\C_0$ is valid and $\QM{of}\notin\dom(\C_0)$. To prove the theorem we need an extra lemma: if the translation is well defined, then $[\![\II_0]\!]$ is well formed.}
