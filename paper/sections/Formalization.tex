...
This also override rejection due to conflicting methods. For example:
\begin{lstlisting}
...
\textbf{B3}        & \cellcolor[HTML]{C0C0C0} conservative error &conflict  error       & conservative error      \\ \hline
\end{tabular}
\\*
