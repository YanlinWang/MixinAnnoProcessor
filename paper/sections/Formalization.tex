...
By email communication with Brian Goetz (lead Java8 designer) we have confirmation that the expected behaviour is rejection, and that this is a bug in ECJ.\footnote{This bug is fixed in the developer version ECJ???, not yet released as stable.}
