...
Java \emph{Classless Java}. \textcolor{red}{Classless Java provides us
...
As a result, we apply object interfaces to several interesting
...
\item {\bf Applications and case studies:} we illustrate the usefulness of IB
  through various examples and case studies. The implementation, case
  studies, and an extended
  technical report with a formal translation to Java are
  online. \footnote{\url{https://github.com/YanlinWang/classless-java}}
