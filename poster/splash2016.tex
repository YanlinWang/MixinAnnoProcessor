...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
   ...
   \begin{enumerate}\compresslist
      \item Generally speaking, multiple inheritance with fields is hard. Moreover, there 
      are problems with field type refinement, constructors, etc.
      \item Java support multiple inheritance with default methods in a limited way.
      \item Other models (traits, mixins, etc) have certain limitatations.
...
\noindent{\includegraphics[width=0.95\linewidth]{pdfs/result.png}\\}
\vspace{0.1em}
}
...
\lstinputlisting[linerange=1-5]{./src.txt}
}
...
\lstinputlisting[linerange=7-11]{./src.txt}
\lstinputlisting[linerange=13-15]{./src.txt}
\vspace{0.1em}
}

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\headerbox{More in the paper}{name=more,column=1,span=2,row=0,below=results}{
  %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Results(Partial)}{name=result2,column=1,below=more}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
In the second case study, we found that embedding DSLs with our implementation of 
fluent interfaces is quite straightforward:
\lstinputlisting[linerange=17-19]{./src.txt}
}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Acknowledgments}{name=acknowledge,column=2,below=more}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This work is sponsored by the Hong Kong Research Grant Council Early Career 
Scheme project number 27200514. The first and second author are supported by 
the SIG PAC stduent travel grant.
   \vspace{0.3em}
  }

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
  \headerbox{Contacts}{name=acknowledge,column=2,below=acknowledge,above=bottom}{
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
