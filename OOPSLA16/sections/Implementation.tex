...
Java supports compilation agents.
...
types breaks heir coherence ``less" than normal library evolution, and
...
\item Eclipse has its own compiler (ejc), alternative to javac.
  Lombok allows writing handlers for either javac of ejc.
