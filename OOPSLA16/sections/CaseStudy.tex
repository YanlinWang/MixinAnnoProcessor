...
&
\lstinputlisting[linerange=55-65]{../UseMixinLombok/src/casestudy/ep/TestExpression.java}% APPLY:linerange=EXPRESSION_PRINT
\end{tabular}
...
\lstinputlisting[linerange=48-51]{../UseMixinLombok/src/casestudy/ep/TestExpression.java}% APPLY:linerange=EXPRESSION_SUB
...
\lstinputlisting[linerange=89-91]{../UseMixinLombok/src/casestudy/ep/TestExpression.java}% APPLY:linerange=INDEPENDENT_EXTENSIBILITY
