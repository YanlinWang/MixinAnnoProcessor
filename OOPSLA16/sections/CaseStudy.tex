...
embedded DSL for SQL languages with fluent interfaces. The third
...
Finally, the fourth one refactors an interpreter, showing that our approach  
benefits modularity and scales to larger and real code base.
