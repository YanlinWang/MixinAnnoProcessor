...
\newcommand\numOfCaseStudies{4 }
\newcommand\classbased{class-based }
\newcommand\interfacebased{interface-based }
\newcommand\InterfaceBased{Interface-Based }
\newcommand\prototypebased{prototype-based }
\newcommand\Prototypebased{Prototype-based }
\newcommand\objectoriented{object-oriented }
\newcommand\Objectoriented{Object-oriented }
