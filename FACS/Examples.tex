...
formally. 
A similarly interleaving approach can be seen in\cite{servetto2014meta} fully formalized.
...
expression.  In full 42 we support with various operators (restrict, hide,
alias) but in \name we focus on the single operator 
$\use$, taking a set
of code values: that is trait names \mt\ or code literals \mL\ and composing them.  This operation, sometimes called \emph{sum}, is the simplest and most elegant
