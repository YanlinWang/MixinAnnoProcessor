...
\bruno{You removed my lengthier explanation. I think this makes things
less clear.}
If in Java code reuse was not introducing subtyping, then an invocation of 
...
that address this limitation: Delta-Trait~\cite{Damiani2014}, Package Templates~\cite{KrogdahlMS09}, DeepFjig~\cite{deep}.
\bruno{Marco, please expand this a bit. Check if references are correct!}
