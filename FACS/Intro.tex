...
completley uncouples subtyping and subclassing in a nominally typed OO
...
Java. Traits are used for code reuse and multiple traits can be
composed to form a class which can then be instantiated. 
