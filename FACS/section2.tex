...
no method called \Q@ma@ is explicitly declared\bruno{but it would not
  work if the \lstinline{ta} was not in the use list, right?}.
...
many spurious abstract method declarations.\bruno{Improved text. 
Please double-check! You may actually show how the code with the extra 
explicit declarations would look like! 
} 
...
\bruno{I don't think we are making  a strong point here, and this
  discussion seems inconsequent at this point!}
