...
OO programmers. By making our
type system distinguish between code use and code reuse we can avoid
many redundant abstract declarations that were required in previous
work by Servetto and Damiani, while supporting self construction,
binary methods and recursive types. Moreover, we provide a novel and elegant solution to uniformly
