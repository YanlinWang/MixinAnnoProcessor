...
Our work is clearly inspired on Traits[sharly]; they are in turn insipired on module composition languages[]
...
Other work cite[something on family polimorphism, scala?]
...
The idea of abstract state operation has emerged from CJ[], and offer a clean solution to handling state
...
Our close contendant is DeepFJig[]: all our gain over their model is based on our relaxation over abstract signatures.
